...
int set_connectionless_UDS_client (char server[], char client[], struct sockaddr_un *userv_addr, int *userv_len) {
    int usfd;
...
int main () {
    ...
    usfd = set_connectionless_UDS_client (SERVER, CLIENT, &userv_addr, &userv_len);
